...
<html lang="en">
	<head>
	    ...
	    <title>Food Re-distribution System Home Page</title>
...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
	<div class="container">
		<div class="Tiffen-container homepage-container">
		<div class="row">
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">On Day Item Back Guarantee.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free delivery-on order over 500 quantities</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">All items-sale up to 20% off on delivery </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#tiffen" data-toggle="tab">Tiffen</a></li>
					<li><a href="#funds" data-toggle="tab">Lunch</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				...
				<img  src="url(assets/images/productimages)/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="180" height="300" alt=""></a>
			</div><!-- /.image -->			
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Tiffen</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Lunch</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
